...
- Repair Swift release container execution, signing-key import and draft lookup; restore the keychain search list and remove temporary keychains even when setup fails. Thanks @steipete.
